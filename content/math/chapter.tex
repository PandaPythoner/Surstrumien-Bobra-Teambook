...
\kactlimport{CRT.cpp}
\kactlimport{Fastmod.cpp}
\kactlimport{ModularSqrt.cpp}
\kactlimport{DiscreteLog.cpp}
%\columnbreak
\kactlimport{PrimalityTest.cpp}
\kactlimport{XorConvolution.cpp}
\kactlimport{Factorization.cpp}
\kactlimport{PrimeCount.cpp}
%\columnbreak
\kactlimport{NTT.cpp}
\kactlimport{FFT.cpp}
%\columnbreak
\kactlimport{AndConvolution.cpp}
\kactlimport{SubsetConvolution.cpp}
\kactlimport{Simplex.cpp}
\kactlimport{DeterminantLd.cpp}
\kactlimport{DeterminantInt.cpp}
\kactlimport{TridiagSLE.cpp}
\kactlimport{SolveLinear.cpp}
\kactlimport{PolyInter.cpp}
\kactlimport{CharPoly.cpp}
\kactlimport{FloorSum.cpp}
\kactlimport{WaysCount.cpp}
\columnbreak
\section{Fun things}
